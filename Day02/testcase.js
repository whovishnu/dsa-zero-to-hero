import { TicketCounter } from "./answer.js";
...
function runTicketCounterTests() {
  ...
  if (tc.peek() === "Bob") passed++; else console.error("❌ Test 1.1 failed");

  // Serve order
  if (tc.serve() === "Bob") passed++; else console.error("❌ Test 1.2 failed");
  if (tc.serve() === "Alice") passed++; else console.error("❌ Test 1.3 failed");
  if (tc.serve() === "Charlie") passed++; else console.error("❌ Test 1.4 failed");
  ...
  // Serve all
  if (tc.serve() === "Zara") passed++; else console.error("❌ Test 2.2 failed");
  if (tc.serve() === "Nina") passed++; else console.error("❌ Test 2.3 failed");
  if (tc.serve() === "Liam") passed++; else console.error("❌ Test 2.4 failed");
  if (tc.serve() === null) passed++; else console.error("❌ Test 2.5 failed");
